...
else if (in_array($widget->position, array('phone','phone-icon', 'social-icons', 'toolbar-r' ,'toolbar-l', 'footer', 'offcanvas'))) {
	$panel = 'uk-panel';
}
...
// Set title
if (in_array($widget->position, array('phone' , 'social-icons', 'toolbar-r' ,'toolbar-l', 'footer'))) {
	$title = '';
