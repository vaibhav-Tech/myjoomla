...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
	...
	<div class="uk-container uk-container-center">
		...
		<?php if ($this['widgets']->count('logo + phone + headerbar')) : ?>
		<div class="tm-headerbar uk-clearfix uk-hidden-small uk-vertical-align">
			...
			<div class="uk-width-3-4 uk-vertical-align-middle">
				<div class="uk-hidden-small uk-float-right"><?php echo $this['widgets']->render('social-icons'); ?></div>
				<div class="uk-hidden-small uk-float-right uk-margin-large-right"><?php echo $this['widgets']->render('phone'); ?></div>
			</div>
		...
		<nav class="tm-navbar uk-navbar">
			...
			<div class="uk-navbar" data-uk-sticky="{top:-200, animation: 'uk-animation-slide-top'}">
				...
				<div class="uk-navbar-flip uk-visible-small"><?php echo $this['widgets']->render('phone-icon'); ?></div>

				<?php if ($this['widgets']->count('search')) : ?>
				<div class="uk-navbar-flip">
					<div class="uk-navbar-content search uk-hidden-small"><?php echo $this['widgets']->render('search'); ?></div>
				</div>
				<?php endif; ?>
		...
		<footer id="tm-footer" class="tm-footer">
			...
			<?php
				echo $this['widgets']->render('footer'),'<br/>';
