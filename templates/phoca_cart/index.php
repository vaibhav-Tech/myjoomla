...
$nameGFont				= $paramsT->get('name_google_font', 'Roboto+Condensed:300,700');
$logoContent   			= $this->params->get('logo', '');
if($logoContent == '') {
	$logoContent = 'templates/phoca_cart/images/logo.png';
}
...
<head>
 ...
 <script src="<?php echo $this->baseurl ?>/templates/phoca_cart/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
  <script src="<?php echo $this->baseurl ?>/templates/phoca_cart/bootstrap/js/twitter-bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
  <script src="<?php echo $this->baseurl ?>/templates/phoca_cart/bootstrap/js/topmenu.js" type="text/javascript"></script>
 <link href="<?php echo $this->baseurl ?>/templates/phoca_cart/bootstrap/css/bootstrap.min.css"  rel="stylesheet" media="screen">
 <link href="<?php echo $this->baseurl ?>/templates/phoca_cart/css/template.css"  rel="stylesheet" media="screen">
 <link href="<?php echo $this->baseurl ?>/templates/phoca_cart/themes/main/theme.css"  rel="stylesheet" media="screen">
...
<style type="text/css">
body {
	font-family: '<?php echo $nameGFont2; ?>', sans-serif;
}
.navbar-nav {
	font-family: '<?php echo $nameGFont2; ?>', sans-serif;
	font-size: 120%;
...
<div id="phnav" class="navbar navbar-default" role="navigation">
	<div class="container">
		<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#phoca-nav">
		  <span class="sr-only"><?php echo JText::_('TPL_PHOCA_CART_TOGGLE_NAVIGATION') ?></span>
